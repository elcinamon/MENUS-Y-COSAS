...
screen quick_menu():
    zorder 100
    imagebutton auto "gui/Icono_personajes_%s.png" xpos 0.8 action ShowMenu("iconos_personajes")
    imagebutton auto "gui/locked_logro_%s.png" xpos 0.6 action ShowMenu("archivo")
    ...
    if quick_menu:
        hbox:
            ...
            imagebutton auto "gui/Iconos/Atras_%s.png" action Rollback() at subida
            imagebutton auto "gui/Iconos/Historial_%s.png" action ShowMenu('history') at subida
            imagebutton auto "gui/Iconos/Saltar_%s.png" action Skip() alternate Skip(fast=True, confirm=True) at subida
            imagebutton auto "gui/Iconos/Auto_%s.png" action Preference("auto-forward", "toggle") at subida
            imagebutton auto "gui/Iconos/Guardar_%s.png" action ShowMenu('save') at subida
            imagebutton auto "gui/Iconos/Guardar_R_%s.png"  action QuickSave() at subida
            imagebutton auto "gui/Iconos/Cargar_R_%s.png"  action QuickLoad() at subida
            imagebutton auto "gui/Iconos/Opciones_%s.png" action ShowMenu('preferences') at subida
...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Logros") action ShowMenu("logros")
...
image pantalla_1 = "gui/overlay/pantalla_inicial_1.png"
image pantalla_2 = "gui/overlay/pantalla_inicial_2.png"
image pantalla_3 = "gui/overlay/pantalla_inicial_3.png"
label splashscreen:
    show pantalla_1 with dissolve
    pause 3
    hide pantalla_1 with dissolve
    show pantalla_3 with dissolve
    pause 3
    hide pantalla_3 with dissolve
    show pantalla_2 with dissolve
    pause 5
    hide pantalla_2 with dissolve
return
screen main_menu():
    ...
    frame:
        ...
        grid 1 6:
            ...
            imagebutton idle "gui/Comenzar_idle.png" hover "comenzar" action Start()

            textbutton _("{size=40}Cargar{/size}") action ShowMenu("load")

            textbutton _("{size=40}Logros{/size}") action ShowMenu("logros")

            textbutton _("{size=40}Galeria{/size}") action ShowMenu("galeria")

            textbutton _("{size=40}Extras{/size}") action ShowMenu("extras")

            textbutton _("{size=40}Salir{/size}") action Quit(confirm=not main_menu)

    imagebutton auto "gui/Iconos/Opciones_%s.png" xpos 1700 ypos 950 action ShowMenu("preferences") 

    imagebutton auto "gui/Iconos/Ayuda_%s.png" xpos 1450 ypos 950 action ShowMenu("help")

    imagebutton auto "gui/Iconos/About_%s.png" xpos 1570 ypos 950 action ShowMenu("about")
...
screen about():
    ...
    use game_menu(_("Acerca de"), scroll="viewport"):
        ...
        vbox:
            ...
            label "[config.name!t]"
            text _("Versión Beta [config.version!t]\n")
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                imagebutton idle "gui/Boton_si.png" hover "boton_si" action yes_action
                imagebutton idle "gui/Boton_no.png" hover "boton_no"  action no_action
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            imagebutton auto "gui/Iconos/Atras_%s.png" action Rollback()
            imagebutton auto "gui/Iconos/Saltar_%s.png" action Skip() alternate Skip(fast=True, confirm=True)
            imagebutton auto "gui/Iconos/Auto_%s.png" action Preference("auto-forward", "toggle")
            imagebutton auto "gui/Iconos/Atras_%s.png" action ShowMenu()
...
screen Barra():
    ...
    frame:
        background "gui/Barra_navegacion.png" yalign 0.1
        ...
        fixed: 
            grid 13 1:
                ...
                if main_menu:
                    ...
                    imagebutton auto "gui/Iconos/Comenzar_%s.png" action Start() 

                else:

                    imagebutton auto "gui/Iconos/Historial_%s.png" action ShowMenu("history")

                    imagebutton auto "gui/Iconos/Guardar_%s.png" action ShowMenu("save")

                imagebutton auto "gui/Iconos/Cargar_%s.png" action ShowMenu("load")

                imagebutton auto "gui/Iconos/Opciones_%s.png" action ShowMenu("preferences")

                imagebutton auto "gui/Iconos/Extras_%s.png" action ShowMenu("extras")

                imagebutton auto "gui/Iconos/Galeria_%s.png" action ShowMenu("galeria")

                imagebutton auto "gui/Iconos/Logro_%s.png" action ShowMenu("logros")
                ...
                if _in_replay:
                    ...
                    imagebutton auto "gui/Iconos/Menu_%s.png" action MainMenu()

                imagebutton auto "gui/Iconos/About_%s.png" action ShowMenu("about")

                if renpy.variant("pc") or (renpy.variant("web") and not renpy.variant("mobile")):

                    ## La ayuda no es necesaria ni relevante en dispositivos móviles.
                    imagebutton auto "gui/Iconos/Ayuda_%s.png" action ShowMenu("help")

                if renpy.variant("pc"):

                    ## El botón de salida está prohibido en iOS y no es necesario en
                    ## Android y Web.
                    imagebutton auto "gui/Iconos/Salir_%s.png" action Quit(confirm=not main_menu)
                
                imagebutton auto "gui/Iconos/Atras_%s.png" action Return() 
...
style game_menu_content_frame:
    xpos -200
    yalign 200
    left_margin 0    # Esto elimina el espacio reservado para la navegación
    right_margin 0
